...
P.s - Credit goes to all original developers of python, pyrogram, linux, heroku, mirror bots, leech bots, Mega, megasdkrest, sql database, google drive, telegram, and everything used in this project,
  ...
  ### Credit ➥ Code Modified actor = [Z Mirror](https://github.com/Dawn-India/Z-Mirror)<p><a href="https://github.com/anasty17/mirror-leech-telegram-bot"> <img src=https://img.shields.io/badge/%E2%96%BA-Z%20Mirror-green"" width="140""/></a></p>
