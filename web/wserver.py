    ...
    <header>
      <div class="brand">
        <img
          ...
          alt="logo"
        />
        <a href="https://t.me/woodcraft_repo">
          <h2 class="name">Qbittorrent Selection</h2>
        </a>
      </div>
      <div class="social">
        <a href="https://github.com/woodcraft5/mirror-leech-bot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/woodcraft_repo"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <div id="sticks">
...
<body>
   <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      ...
      <div class="social">
        <a href="https://www.github.com/woodcraft5/mirror-leech-bot"><i class="fab fa-github"></i></a>
        <a href="https://t.me/woodcraft_repo"><i class="fab fa-telegram"></i></a>
      </div>
    </header>
    <section>
...
@app.route('/')
def homepage():
    return "<h1>See mirror-leech-bot <a href='https://www.github.com/woodcraft5/mirror-leech-bot'>@GitHub</a> By <a href='https://github.com/woodcraft5'>WOODcraft</a></h1>"
