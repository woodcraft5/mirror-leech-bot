...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="https://telegra.ph/file/4af5827a10064b6219e02.jpg" type="image/jpg">
    <script
...
<body>
  <!--© Designed and coded by @bipuldey19-Telegram-->
    <header>
      <div class="brand">
        <img
          src="https://telegra.ph/file/4af5827a10064b6219e02.jpg"
          alt="logo"
        />
...
@app.route('/')
def homepage():
    return "<h1>See @woodcraft_repo_bot <a href='https://github.com/woodcraft5/mirror-leech-bot'>@GitHub</a> By <a href='https://github.com/woodcraft5'>woodcraft5</a></h1>"
