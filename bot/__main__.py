...
'''
        sendMarkup(start_string, context.bot, effective_message, update.message, reply_photo("https://telegra.ph/file/48fab66115573350043b5.jpg", parse_mode=ParseMode.MARKDOWN)
    else:
