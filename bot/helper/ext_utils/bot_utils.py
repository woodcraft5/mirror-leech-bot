...
from bot import download_dict, download_dict_lock, STATUS_LIMIT, botStartTime, IMAGE_URL, DOWNLOAD_DIR
...
def get_readable_message():
    with download_dict_lock:
        ...
        for index, download in enumerate(list(download_dict.values())[COUNT:], start=1):
            msg += f"\n\n<b>update.effective_message.reply_photo(IMAGE_URL, start_string, parse_mode=ParseMode.MARKDOWN, reply_markup=reply_markup)"
